            ...
            <form method="post" action='<c:url value="/addClient"/>'>
              ...
              <div class="row mb-3">
                <div class="col-md-2">
                    ...
                    <input class="form-control" id="inputZipCode" type="text" name="zipCode" required="required" pattern="[0-9]{2}-[0-9]{3}" placeholder="Wprowadź kod pocztowy" />
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                  ...
                  <div class="col-md-2">
                      ...
                      <input class="form-control" id="inputApartment" type="text" name="apartment" value="-" placeholder="Wprowadź numer mieszkania" />
                  </div>
              </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="inputEmail" type="text" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Wprowadź adres mailowy" />
                    </div>
                </div>
              <div class="mt-4 mb-0">
