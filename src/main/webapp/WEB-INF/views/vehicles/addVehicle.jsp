            ...
            <form method="post" action='<c:url value="/addVehicle"/>'>
              ...
              <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input class="form-control" id="inputYearOfProduction" type="text" name="yearOfProduction" required="required" pattern="[12][0-9]{3}" placeholder="Wprowadź rok produkcji" />
                </div>
                <div class="col-md-4">
